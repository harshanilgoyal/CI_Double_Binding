...
<div class="col-lg">
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h4>Earthing And Protection</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-3">
            <div class="card" style="width: 12rem;margin:10px">
                    <img style="width: 12rem;border-radius:50%;" class="card-img-top" src="images/earthing.jpg" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text" align=center>Earthing</p>
                    </div>
            </div>
            </div>
         <div class="col-sm-5">
