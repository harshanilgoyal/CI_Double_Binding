    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="card" style="width: 12rem;margin:10px">
                    <img style="width: 12rem;border-radius:50%;" class="card-img-top" src="images/cables.jpg" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text" align=center>Cables</p>
                    </div>
            </div>
            </div>
         <div class="col-sm-5">
            <form class="well form-horizontal">
                      <fieldset>
                         <div class="form-group row" style="padding:20px">
                          ...
                          <div class="form-group row"  style="padding:20px">
                           <label class="col-sm-5 control-label" >Length Required</label>
