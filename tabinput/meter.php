...
<div class="col-lg">
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h4>Meter & Licensing</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-3">
            <div class="card" style="width: 12rem;margin:10px">
                    <img style="width: 12rem;border-radius:50%;" class="card-img-top" src="images/meter.jpg" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text" align=center>Meter</p>
                    </div>
            </div>
            </div>
         <div class="col-sm-5">
